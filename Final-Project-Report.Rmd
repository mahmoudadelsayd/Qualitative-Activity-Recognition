...
GitHub Repo: [https://github.com/mahmoudadelsayd/Qualitative-Activity-Recognition](https://github.com/mahmoudadelsayd/Qualitative-Activity-Recognitiont)  
...
rfGrid <-  expand.grid(interaction.depth = c(1, 5, 9),
                        ntrees = (1:30)*50,
                        shrinkage = 0.1)
modelRF <- randomForest(classe ~., data =  training, method ="rf") 
print(modelRF)
plot(modelRF)
```  
